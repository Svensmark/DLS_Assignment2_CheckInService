    ...
    */
    ...
    public static EntityManagerFactory createEntityManagerFactory(DbSelector dbType,Strategy strategy){
        ...
        if(dbType == DbSelector.DEV){
            ...
            user = System.getenv("db.user")!= null ? System.getenv("db.user") : System.getenv("db.user") ;
            pw = System.getenv("db.password")!= null ? System.getenv("db.password") : System.getenv("db.password") ;
        }
    ...
    public static EntityManagerFactory createEntityManagerFactory(
        ...
        if (System.getProperty("IS_INTEGRATION_TEST_WITH_DB") != null) {
            ...
            connection_str = Settings.getTEST_DBConnection();
            user = System.getenv("db.user") != null ? System.getenv("db.user") : user;
            pw = System.getenv("db.password") != null ? System.getenv("db.password") : pw;
        }
